...
export const UIConfigFour = ({ onSwitchToText }: UIConfigFourProps) => {
  return (
    <div className="h-full w-full bg-background p-4 flex flex-col gap-3 overflow-hidden">
      ...
      <Panel className="shrink-0 py-8 px-4" interactive>
        <div className="flex items-center justify-center relative">
          {/* Centered Mic Button */}
          <button 
            className="p-6 rounded-full border-2 border-muted-foreground/40 text-muted-foreground hover:border-primary hover:text-primary transition-colors"
          ...
          <button 
            ...
            className="absolute right-4 bottom-0 p-2 text-muted-foreground hover:text-primary transition-colors"
